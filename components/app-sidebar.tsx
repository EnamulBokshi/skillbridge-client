    ...
    <Sidebar collapsible="offcanvas" {...props}>
      <SidebarHeader>
        <SidebarMenu>
          ...
          <SidebarMenuItem className="mt-6 bg-linear-to-r from-primary to-secondary hover:opacity-90 text-primary-foreground rounded-md text-center transition-all duration-300 text-base font-semibold">
            <SidebarMenuButton
              asChild
              className="data-[slot=sidebar-menu-button]:p-1.5! flex justify-center items-center w-full"
            >
